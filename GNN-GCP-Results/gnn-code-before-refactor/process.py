...
def process():
  ...
  for datafolder in os.listdir(directory):
      ...
      # try:
      feature_df, find_count = preprocess(csvfiles + "/" + datafolder + ".fasta.csv")
      ...
      print("Test Accuracy: ", test_acc, len(test_set), pred[feature_df["find_set"]], feature_df["find_set"].sum(), len(feature_df))

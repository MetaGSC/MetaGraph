...
def iterate(model, optimizer, criterion, data, train_data, validate_test):
  for epoch in range(1, 101):
      loss = train(model, optimizer, criterion, data, train_data)
      test_acc, h = test(model, data, validate_test)
      if _DEBUG or True:
        print(f'Epoch: ', epoch, " Validation accuracy ", 1 - test_acc)

...
kmer4folder = "/home/hp/FYP/GNN2/gnn-code/kmer4"
_DEBUG = False
...
def process():
  ...
  for datafolder in os.listdir(directory):
      ...
      kmerfilepath = kmer4folder + "/" + datafolder + "-4mer"
      ...
      try:
        feature_df, find_count = preprocess(csvfiles + "/" + datafolder + ".fasta.probs.out", fastafilepath, kmerfilepath)
      except:
        continue
